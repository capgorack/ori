...
Houve enorme dedicação teórica inicial na operação exclusiva sobre processadores simples (x86-64 e afins), por motivos estritamente concentrados a garantir a soberania no que tange a ausência de datacenters terceirizados ou alocação de nuvem, mantendo o controle total da privacidade (viabilizando isolamento físico). 
